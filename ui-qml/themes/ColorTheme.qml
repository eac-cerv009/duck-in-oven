...
Item {
    readonly property color defaultStateColor: "#F2F2F2"
    readonly property color activedStateColor: "#71E51A"
    ...
    readonly property color bottomBarBackgroundColor: "#393939"

    readonly property color iconButtonBackgroundColor: "#424241"
    readonly property color iconButtonBorderColor: "#9C9C9C"

    readonly property color textButtonBackgroundColor: "#51504F"
    readonly property color textButtonBorderColor: "#C4C4C4"
